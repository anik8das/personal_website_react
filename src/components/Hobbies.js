		...
		<div
			...
			<div className="flex w-screen mb-2 sm:mb-5 lg:mb-8 xl:mb-11">
				<div
					...
					<button class="text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://www.worldcubeassociation.org/persons/2015DASA02")}>
						My WCA profile
					</button>
				</div>
				<div
					...
					<button class="absolute bottom-3 sm:bottom-5 text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://github.com/anik8das")}>
						My Github
					</button>
				</div>
			</div>
			<div className="flex w-screen">
				<div
					...
					<button class="absolute bottom-3 sm:bottom-5 text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://medium.com/@anik8das")}>
						My Medium Page
					</button>
				</div>
				<div
					...
					<button class="text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://unsplash.com/@anik8das")}>
						My Unsplash
					</button>
				</div>
			</div>
