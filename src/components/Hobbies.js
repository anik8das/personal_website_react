		...
		<div
			...
			<div className="flex w-screen mb-2 sm:mb-5 lg:mb-8 xl:mb-11">
				<div
					...
					data-aos="fade-down-right" data-aos-duration="700">
					...
					<button className="text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://www.worldcubeassociation.org/persons/2015DASA02")}>
						My WCA profile
					</button>
				</div>
				<div
					...
					data-aos="fade-down-left" data-aos-duration="700">
					<div className="font-bold text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl 2xl:text-2xl mb-2 sm:mb-3">
						Code
					</div>
					...
					<button className="absolute bottom-3 sm:bottom-5 text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://github.com/anik8das")}>
						My Github
					</button>
				</div>
			</div>
			<div className="flex w-screen">
				<div
					...
					data-aos="fade-up-right" data-aos-duration="700">
					<div className="font-bold text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl 2xl:text-2xl mb-2 sm:mb-3">
						Travel and snap
					</div>
					<div className="text-white text-xs sm:text-sm lg:text-base 2xl:text-xl">
					...
					<button className="absolute bottom-3 sm:bottom-5 text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://unsplash.com/@anik8das")}>
						My Unsplash
					</button>
				</div>
				<div
					...
					data-aos="fade-up-left" data-aos-duration="700">
					<div className="font-bold text-gray-300 text-sm sm:text-base md:text-lg lg:text-xl 2xl:text-2xl mb-2 sm:mb-3">
					...
					<button className="text-xs sm:text-sm lg:text-base 2xl:text-xl bg-transparent hover:bg-white text-white font-semibold hover:text-black border border-white hover:border-transparent rounded p-2" onClick={()=>openLink("https://medium.com/@anik8das")}>
						My Medium Page
					</button>
				</div>
			</div>
